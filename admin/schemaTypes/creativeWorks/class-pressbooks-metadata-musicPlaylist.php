...
/**
 * The class for the musicPlaylist
 *
...
class Pressbooks_Metadata_MusicPlaylist extends Pressbooks_Metadata_Type {
	 ...
	 * @access   public
	 */
	static $type_setting = array('musicPlaylist_type' => array('MusicPlaylist Type','http://schema.org/MusicPlaylist'));
	...
	static $type_properties = array(
		'numTracks' => array(false,'Number of tracks','The number of tracks in this album or playlist.'),
		'track' => array(false,'Tracks','A music recording (track)—usually a single song. If an ItemList is given, the list should contain items of type MusicRecording. Supersedes tracks.')
	);
