...
class Pressbooks_Metadata_ClaimReview {
	 ...
	 * @access   public
	 */
	public static $type_settings = array('claimReview_type' => array('Claim Review Type','http://schema.org/ClaimReview'));
	...
	public function pmdt_parent_init(){
		return new Pressbooks_Metadata_Review($this->type_level);
	}
