...
/**
 * The class for the claim review type including operations and metaboxes
 *
...
class Pressbooks_Metadata_ClaimReview extends Pressbooks_Metadata_Type {

	public function __construct($type_level_input) {
		parent::__construct($type_level_input);
		$this->class_name = __CLASS__ .'_'. $this->type_level;
		$this->type_settings = array('claimReview_type' => array('Claim Review Type','http://schema.org/ClaimReview'));
		$this->parent_type = new Pressbooks_Metadata_Review($this->type_level);
	...
	/**
	 * The function which produces the metaboxes for the claim review type
	...
	private function pmdt_add_metabox($meta_position){
		...
		//----------- metabox ----------- //
		x_add_metadata_group( 	'ClaimReview', $meta_position, array(
			'label' 		=>	'Claim Review Type Properties',
			'priority' 		=>	'high',
		) );
		//----------- metafields ----------- //
		...
		// Claim Reviewed
		x_add_metadata_field( 	'pb_claimReviewed_'.$meta_position, $meta_position, array(
			'group' 		=> 	'ClaimReview',
	...
	/**
	 * A function that creates the metadata for the claim review type.
	 * @since 0.8.1
	 *
	 */
	public function pmdt_get_metatags() {
		...
		$ClaimReview_data = array(

			'claimReviewed' => 'pb_claimReviewed'
		);

		$html = "<!-- Microtags --> \n";

		$html .= '<div itemscope itemtype="http://schema.org/ClaimReview">';

		foreach ( $ClaimReview_data as $itemprop => $content ) {
