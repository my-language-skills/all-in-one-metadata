...
class Pressbooks_Metadata_EmailMessage {
	 ...
	 * @access   public
	 */
	public static $type_settings = array('emailMessage_type' => array('Email Message Type','http://schema.org/EmailMessage'));
	...
	public function pmdt_parent_init(){
		return new Pressbooks_Metadata_Message($this->type_level);
	}
