...
use schemaTypes\place\Pressbooks_Metadata_Place;
...
class Pressbooks_Metadata_MusicAlbum extends Pressbooks_Metadata_Type {

	public function __construct($type_level_input) {
		parent::__construct($type_level_input);
		$this->class_name = __CLASS__ .'_'. $this->type_level;
		$this->type_settings = array('musicAlbum_type' => array('Music Album Type','http://schema.org/MusicAlbum'));
		$this->parent_type = new Pressbooks_Metadata_Music_Playlist($this->type_level);
	...
	/**
	 * The function which produces the metaboxes for the music album type
	...
	/**
	 * A function that creates the metadata for the music album type.
	 * @since 0.8.1
	 *
	 */
