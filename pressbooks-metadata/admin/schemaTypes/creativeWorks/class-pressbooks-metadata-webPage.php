...
class Pressbooks_Metadata_WebPage extends Pressbooks_Metadata_Empty_Type {

	public function __construct($type_level_input) {
		parent::__construct($type_level_input);
		$this->class_name = __CLASS__ .'_'. $this->type_level;
		$this->type_settings = array('webPage_type' => array('Web Page Type','http://schema.org/WebPage'));
