...
class Pressbooks_Metadata_Creative_Work_Series {
	 ...
	 * @access   public
	 */
	public static $type_settings = array('creativeWorkSeries_type'        => array('Creative Work Series Type','http://schema.org/CreativeWorkSeries'));
