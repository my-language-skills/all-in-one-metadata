...
class Pressbooks_Metadata_Publication_Issue {
	 ...
	 * @access   public
	 */
	public static $type_settings = array('publicationIssue_type' => array('Publication Issue Type','http://schema.org/PublicationIssue'));
