...
class Pressbooks_Metadata_Recipe extends Pressbooks_Metadata_Type {

	public function __construct($type_level_input) {
		parent::__construct($type_level_input);
		$this->class_name = __CLASS__ .'_'. $this->type_level;
		$this->type_settings = array('recipe_type' => array('Recipe Type','http://schema.org/Recipe'));
