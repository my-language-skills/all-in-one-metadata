...
/**
 * The class for the publication volume type including operations and metaboxes
 *
...
class Pressbooks_Metadata_Publication_Volume extends Pressbooks_Metadata_Type {

	public function __construct($type_level_input) {
		parent::__construct($type_level_input);
		$this->class_name = __CLASS__ .'_'. $this->type_level;
		$this->type_settings = array('publicationVolume_type' => array('Publication Volume Type','http://schema.org/PublicationVolume'));
	...
	/**
	 * The function which produces the metaboxes for the publication volume type
	...
	private function pmdt_add_metabox($meta_position){
		...
		// Volume Number
		x_add_metadata_field( 	'pb_volume_number_'.$meta_position, $meta_position, array(
			'group' 		=> 	'publication-volume',
			'label' 		=> 	'Volume Number',
	...
	/**
	 * A function that creates the metadata for the Publication Volume type.
	 * @since 0.8.1
	 *
	 */
	public function pmdt_get_metatags() {
		...
		$publicationVolume_data = array(

			'pageEnd' => 'pb_page_end',
			'pageStart' => 'pb_page_start',
			'pagination' => 'pb_pagination',
			'volumeNumber' => 'pb_volume_number'

		);

		$html = "<!-- Microtags --> \n";

		$html .= '<div itemscope itemtype="http://schema.org/PublicationVolume">';

		foreach ( $publicationVolume_data as $itemprop => $content ) {
