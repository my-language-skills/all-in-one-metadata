...
class Pressbooks_Metadata_Publication_Volume{
	 ...
	 * @access   public
	 */
	public static $type_settings = array('publicationVolume_type' => array('Publication Volume Type','http://schema.org/PublicationVolume'));
