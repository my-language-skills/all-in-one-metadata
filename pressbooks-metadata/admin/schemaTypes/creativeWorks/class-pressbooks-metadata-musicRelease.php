...
class Pressbooks_Metadata_MusicRelease extends Pressbooks_Metadata_Type {

	public function __construct($type_level_input) {
		parent::__construct($type_level_input);
		$this->class_name = __CLASS__ .'_'. $this->type_level;
		$this->type_settings = array('musicRelease_type' => array('Music Release Type','http://schema.org/MusicRelease'));
	...
	/**
	 * The function which produces the metaboxes for the music release type
	...
	/**
	 * A function that creates the metadata for the music release type.
	 * @since 0.8.1
	 *
	 */
