...
class Pressbooks_Metadata_Software_Application extends Pressbooks_Metadata_Type {

	public function __construct($type_level_input) {
		parent::__construct($type_level_input);
		$this->class_name = __CLASS__ .'_'. $this->type_level;
		$this->type_settings = array('sofwareApplication_type' => array('Software Application Type','http://schema.org/softwareApplication'));
