...
class Pressbooks_Metadata_Tv_Series extends Pressbooks_Metadata_Type {

	public function __construct($type_level_input) {
		parent::__construct($type_level_input);
		$this->class_name = __CLASS__ .'_'. $this->type_level;
		$this->type_settings = array('tvSeries_type' => array('Tv Series Type','http://schema.org/TvSeries'));
