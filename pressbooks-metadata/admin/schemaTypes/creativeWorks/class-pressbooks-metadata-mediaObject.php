...
class Pressbooks_Metadata_Media_Object extends Pressbooks_Metadata_Type {

	public function __construct($type_level_input) {
		parent::__construct($type_level_input);
		$this->class_name = __CLASS__ .'_'. $this->type_level;
		$this->type_settings = array('mediaObject_type' => array('Media Object Type','http://schema.org/MediaObject'));
