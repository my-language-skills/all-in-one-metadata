...
class Pressbooks_Metadata_Visual_Art_Work extends Pressbooks_Metadata_Type {

	public function __construct($type_level_input) {
		parent::__construct($type_level_input);
		$this->class_name = __CLASS__ .'_'. $this->type_level;
		$this->type_settings = array('visualArtWork_type'=> array('Visual Artwork Type','http://schema.org/VisualArtwork'));
