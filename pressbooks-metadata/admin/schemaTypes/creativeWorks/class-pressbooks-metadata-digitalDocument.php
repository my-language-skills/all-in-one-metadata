...
class Pressbooks_Metadata_Digital_Document {
	 ...
	 * @access   public
	 */
	public static $type_settings = array('digitalDocument_type' => array('Digital Document Type','http://schema.org/DigitalDocument'));
