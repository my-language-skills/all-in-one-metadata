...
class Pressbooks_Metadata_Corporation {
	...
	private function pmdt_add_metabox($meta_position){
		//----------- metabox ----------- //
		x_add_metadata_group(  'Corporation', $meta_position, array(
			'label'       => 'Corporation Type Properties',
			'priority'        => 'high',
		) );
		//----------- metafields ----------- //
		// [schemaprop]
		...
		// Ticker Symbol
		x_add_metadata_field(  'pb_tickerSymbol_'.$meta_position, $meta_position, array(
			'group'       =>     'Corporation',
			'label'       =>     'Ticker Symbol',
	...
	public function pmdt_get_metatags() {
		...
		$Corporation_data = array(
			...
			'tickerSymbol' => 'pb_tickerSymbol'
		);

		$html = "<!-- Microtags --> \n";

		$html .= '<div itemscope itemtype="http://schema.org/Corporation">';

		foreach ( $Corporation_data as $itemprop => $content ) {
