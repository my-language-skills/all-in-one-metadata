...
class Pressbooks_Metadata_SportsOrganization {
	...
	private function pmdt_add_metabox($meta_position){
		//----------- metabox ----------- //
		x_add_metadata_group(  'SportsOrganization', $meta_position, array(
			'label'       => 'Sports Organization Type Properties',
			'priority'        => 'high',
		) );
		//----------- metafields ----------- //
		// [schemaprop]
		...
		// Sport
		x_add_metadata_field(  'pb_sport_'.$meta_position, $meta_position, array(
			'group'       =>     'SportsOrganization',
			'label'       =>     'Sport',
	...
	public function pmdt_get_metatags() {
		...
		$html .= '<div itemscope itemtype="http://schema.org/SportsOrganization">';

		foreach ( $SportsOrganization_data as $itemprop => $content ) {
