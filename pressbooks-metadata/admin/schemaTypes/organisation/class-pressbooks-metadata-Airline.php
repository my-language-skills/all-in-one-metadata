...
class Pressbooks_Metadata_Airline {
	...
	private function pmdt_add_metabox($meta_position){
		//----------- metabox ----------- //
		x_add_metadata_group(  'Airline', $meta_position, array(
			'label'       => 'Airline Type Properties',
			'priority'        => 'high',
		) );
		//----------- metafields ----------- //
		// [schemaprop]
		...
		// Boarding Policy
		x_add_metadata_field(  'pb_boardingPolicy_'.$meta_position, $meta_position, array(
			'group'       =>     'Airline',
		...
		// IATA Code
		x_add_metadata_field(  'pb_iataCode_'.$meta_position, $meta_position, array(
			'group'       =>     'Airline',
			'label'       =>     'IATA Code',
	...
	public function pmdt_get_metatags() {
		...
		$Airline_data = array(
			...
			'boardingPolicy' => 'pb_boardingPolicy',
			'iataCode' => 'pb_iataCode'
		);

		$html = "<!-- Microtags --> \n";

		$html .= '<div itemscope itemtype="http://schema.org/Airline">';

		foreach ( $Airline_data as $itemprop => $content ) {
