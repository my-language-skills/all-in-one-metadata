...
<?php get_template_part( 'content', 'accessibility-toolbar' ); ?>
	 ...
	 <?php if (is_front_page()):?>
	 	...
	 	<!-- Inside the <span itemscope itemtype="http://schema.org/Book" itemref=" about author !!HERE!! "> we put the properties that we want to use in our metatags. Pressbooks has by default some of these properties in there. The properties that it uses. For example interactivityType, learningResourceType and typicalAgeRange. If we try to add one of these in there, they will show up twice in our Book Table, and we don't want that.
	 	Important: All these properties are the itemprops ids, not the itemprops themselves  -->
		...
		image inLanguage keywords publisher educationalUse educationalAlignment1 educationalAlignment2
<?php
if ( is_front_page() ) {
