...
class Pressbooks_Metadata_Map extends Pressbooks_Metadata_Type {
	 ...
	 * @access   public
	 */
	static $type_setting = array('map_type' => array('Map Type','http://schema.org/Map'));
	...
	static $type_properties = array(
		'mapType' => array(false,'Map Category Type ','Indicates the kind of Map, from the MapCategoryType Enumeration.')
	);
