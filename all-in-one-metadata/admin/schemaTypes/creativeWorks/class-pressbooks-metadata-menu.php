...
class Pressbooks_Metadata_Menu extends Pressbooks_Metadata_Type {
	...
	static $type_properties = array(
		'hasMenuItem' => array(false,'Menu Item','A food or drink item contained in a menu or menu section.'),
		'hasMenuSection' => array(false,'Menu Section','A subgrouping of the menu (by dishes, course, serving time period, etc.).')
	);
