...
class Pressbooks_Metadata_Comment extends Pressbooks_Metadata_Type {
	 ...
	 * @access   public
	 */
	static $type_setting = array('comment_type' => array('Comment Type','http://schema.org/Comment'));
	...
	static $type_properties = array(
		...
		'parentItem' => array(false,'Parent Item','The parent of a question, answer or item in general.'),
