...
/**
 * The class for the digitalDocument
 *
...
class Pressbooks_Metadata_DigitalDocument extends Pressbooks_Metadata_Type {
	 ...
	 * @access   public
	 */
	static $type_setting = array('digitalDocument_type' => array('DigitalDocument Type','http://schema.org/DigitalDocument'));
	...
	static $type_properties = array(
		'hasDigitalDocumentPermission' => array(false,'Has Digital Document Permission','A permission related to the access to this document (e.g. permission to read or write an electronic document). For a public document, specify a grantee with an Audience with audienceType equal to "public".')
	);
