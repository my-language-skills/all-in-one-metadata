...
/**
 * The class for the publicationVolume
 *
...
class Pressbooks_Metadata_PublicationVolume extends Pressbooks_Metadata_Type {
	 ...
	 * @access   public
	 */
	static $type_setting = array('publicationVolume_type' => array('PublicationVolume Type','http://schema.org/PublicationVolume'));
	...
	static $type_properties = array(
		...
		'volumeNumber' => array(false,'Volume Number','Identifies the volume of publication; for example, "iii" or "2".')
	);
