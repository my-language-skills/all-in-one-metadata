...
/**
 * The class for the softwareSourceCode
 *
...
class Pressbooks_Metadata_SoftwareSourceCode extends Pressbooks_Metadata_Type {
	 ...
	 * @access   public
	 */
	static $type_setting = array('softwareSourceCode_type' => array('SoftwareSourceCode Type','http://schema.org/SoftwareSourceCode'));
	...
	static $type_properties = array(
		'codeRepository' => array(false,'Code Repository','Link to the repository where the un-compiled, human readable code and related code is located (SVN, github, CodePlex).'),
