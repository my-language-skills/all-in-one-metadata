...
/**
 * The class for the medicalOrganization
 *
...
class Pressbooks_Metadata_MedicalOrganization extends Pressbooks_Metadata_Type {
	 ...
	 * @access   public
	 */
	static $type_setting = array('medicalOrganization_type' => array('MedicalOrganization Type','http://schema.org/MedicalOrganization'));
	...
	static $type_properties = array(
		'healthPlanNetworkId' => array(false,'Health Plan Network Id','Name or unique ID of network.'),
		'isAcceptingNewPatients' => array(false,'Is Accepting New Patients','Whether the provider is accepting new patients.'),
		'medicalSpecialty' => array(false,'Medical Specialty','A medical specialty of the provider.')
	);
