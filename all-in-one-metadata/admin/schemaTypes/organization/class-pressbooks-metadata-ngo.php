...
class Pressbooks_Metadata_NGO extends Pressbooks_Metadata_Type {
	 ...
	 * @access   public
	 */
	static $type_setting = array('ngo_type' => array('NGO Type','http://schema.org/NGO','Organization'));
